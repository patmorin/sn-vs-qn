...
\todo{Do we want a figure showing an example of a stack layout and a queue layout here? $H_4$ would be a good example. Then we could refer to it when we show $\sqn(H_n)\leq 3$. }
...
\begin{figure}[H]
	...
	\caption{A strict $3$-queue layout and a $2$-stack layout of $H_4$}
	\label{layouts}
\end{figure}
