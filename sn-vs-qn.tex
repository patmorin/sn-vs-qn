...
Stack and queue layouts have other applications including fault-tolerant multiprocessing~\citep{CLR87,Rosenberg83a,Rosenberg86a,Rosenberg86}, stack sorting~\citep{CLR87}, traffic control~\citep{Kainen90}, graph drawing in two~\citep{BB04,ADFPR12,SSSV-WG94} and three dimensions~\citep{DMW05,Wood-GD01,DMW17}, RNA folding~\citep{HS99}, and computational complexity~\citep{GKS89,DSW16,Bourgain09,BY13}. See  \citep{BK79,BO01,DujWoo04,DujWoo-DCG07,DJMMUW20,DFP13,BFGMMRU19,Yannakakis89,Yann20,MBKPRU20} for bounds on the stack- and queue-number for various graph classes. 
