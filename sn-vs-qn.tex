...
\begin{figure}
	\begin{center}
		\begin{tabular}{m{.3\textwidth}m{2ex}m{.3\textwidth}}
		\includegraphics{figs/s} & $\Box$ & \includegraphics{figs/q}
	\end{tabular}
	\end{center}
